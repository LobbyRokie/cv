...
## 🛠️ TOOL BOX
**Data Analytics:**       Tableau, Power BI, MicroStrategy, SAS, SPSS, SSRS, SSMS, SSIS, AWS, Azure, Access, Excel, XLMiner, FICO Analytics, Google Analytics. <br>
**Programming:** 	        SQL, R, Python, Java, C++, DAX, MDX, Power Query, M Query, MATLAB, Visual Basic, VBA, XML. <br>
**Other Tools:** 		      Salesforce, SAP, Jira, Git, Visual Studio, Tabular Editor, DAX Studio, Smartsheet, SharePoint, PeopleSoft, Oracle Financials, QuickBooks, NLS. <br>
...
* **Business Intelligence:** Revolutionized and automated the department's reporting process with robust and scalable self-service BI solutions. Created and owned 20+ workspaces and apps to support 5 business units and over 40 end users, including AVC, CFO, directors, and managers. Designed, developed, and implemented end-to-end data analytics solutions, including data mining, data manipulation, data modeling, data analysis, and data reporting. Enhanced data pipelines, generated actionable insights, and provided data-driven recommendations to the executive team, improving process efficiency by 15-25% and saving 100-120 hours and thousands of dollars per month across multiple business operations.
